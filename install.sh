...
log "  - Input hardening: sudo system/vault/install.sh  (uaccess ACL on the Power"
log "    Button evdev node so mango-powerkey survives 'gpasswd -d martin input';"
log "    see VAULT.md for the full wallet-isolation + input-sniffing design)"
